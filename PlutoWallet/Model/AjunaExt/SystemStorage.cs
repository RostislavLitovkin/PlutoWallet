...
namespace PlutoWallet.Model.AjunaExt
{
    public sealed class SystemStorage
    {
        ...
        /// </summary>
        public async Task<AjunaExample.NetApiExt.Generated.Model.frame_system.AccountInfo> Account(string substrateAddress)
        {
            var account32 = new AccountId32();
            account32.Create(Utils.GetPublicKeyFrom(substrateAddress));
        
            string parameters = SystemStorage.AccountParams(account32);
            var result = await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.frame_system.AccountInfo>(parameters, CancellationToken.None);
            return result;
        }
