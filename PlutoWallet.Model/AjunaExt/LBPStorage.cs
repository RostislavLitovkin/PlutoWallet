...
namespace PlutoWallet.Model.Storage
{
    ...
    public sealed class LBPStorage
    {
        ...
        public LBPStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("LBP", "PoolData"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Generated.Model.pallet_lbp.Pool)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("LBP", "FeeCollectorWithAsset"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.NetApi.Model.Types.Primitive.Bool)));
        }
        ...
        ///  Details of a pool.
        /// </summary>
        public static string PoolDataParams(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Details of a pool.
        /// </summary>
        public async Task<Substrate.NetApi.Generated.Model.pallet_lbp.Pool> PoolData(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = LBPStorage.PoolDataParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Generated.Model.pallet_lbp.Pool>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string FeeCollectorWithAssetParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        ///  Not more than one fee collector per asset possible
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> FeeCollectorWithAsset(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
    ...
    public sealed class LBPCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 pool_owner, Substrate.NetApi.Model.Types.Primitive.U32 asset_a, Substrate.NetApi.Model.Types.Primitive.U128 asset_a_amount, Substrate.NetApi.Model.Types.Primitive.U32 asset_b, Substrate.NetApi.Model.Types.Primitive.U128 asset_b_amount, Substrate.NetApi.Model.Types.Primitive.U32 initial_weight, Substrate.NetApi.Model.Types.Primitive.U32 final_weight, Substrate.NetApi.Generated.Model.pallet_lbp.EnumWeightCurveType weight_curve, Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> fee, Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 fee_collector, Substrate.NetApi.Model.Types.Primitive.U128 repay_target)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UpdatePoolData(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 pool_id, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32> pool_owner, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> start, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> end, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> initial_weight, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> final_weight, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>> fee, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32> fee_collector, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> repay_target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RemoveLiquidity(Substrate.NetApi.Generated.Model.sp_core.crypto.AccountId32 pool_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
