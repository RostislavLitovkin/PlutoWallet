...
namespace Bifrost.NetApi.Generated.Model.xcm.v3
{
    ...
    /// <summary>
    /// >> 176 - Composite[xcm.v3.QueryResponseInfo]
    /// </summary>
    ...
    public sealed class QueryResponseInfo : BaseType
    {
        ...
        /// >> destination
        /// </summary>
        public Bifrost.NetApi.Generated.Model.staging_xcm.v3.multilocation.MultiLocation Destination { get; set; }
        /// <summary>
        /// >> query_id
        /// </summary>
        ...
        {
            var start = p;
            Destination = new Bifrost.NetApi.Generated.Model.staging_xcm.v3.multilocation.MultiLocation();
