...
namespace Bifrost.NetApi.Generated.Model.cumulus_pallet_parachain_system
{
    
    
    /// <summary>
    /// >> 504 - Composite[cumulus_pallet_parachain_system.CodeUpgradeAuthorization]
    /// </summary>
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Bifrost.NetApi.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Bifrost.NetApi.Generated.Model.primitive_types.H256();
