...
namespace Bifrost.NetApi.Generated.Model.bifrost_vtoken_voting.vote
{
    ...
    /// <summary>
    /// >> 813 - Composite[bifrost_vtoken_voting.vote.Casting]
    /// </summary>
    ...
    public sealed class Casting : BaseType
    {
        ...
        /// >> votes
        /// </summary>
        public Bifrost.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55 Votes { get; set; }
        /// <summary>
        /// >> delegations
        /// </summary>
        ...
        {
            var start = p;
            Votes = new Bifrost.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55();
