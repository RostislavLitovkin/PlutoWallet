...
namespace Hydration.NetApi.Generated.Model.pallet_asset_registry.types
{
    ...
    /// <summary>
    /// >> 487 - Composite[pallet_asset_registry.types.AssetDetails]
    /// </summary>
    ...
    public sealed class AssetDetails : BaseType
    {
        ...
        /// >> name
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4> Name { get; set; }
        /// <summary>
        /// >> asset_type
        /// </summary>
        ...
        /// >> symbol
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4> Symbol { get; set; }
        /// <summary>
        /// >> decimals
        /// </summary>
        ...
        {
            var start = p;
            Name = new Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4>();
            ...
            Symbol = new Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4>();
