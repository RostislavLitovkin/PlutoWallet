...
namespace Substrate.NetApi.Generated.Model.pallet_referenda.types
{
    ...
    public sealed class ReferendumStatus : BaseType
    {
        ...
        /// >> origin
        /// </summary>
        public Substrate.NetApi.Generated.Model.polkadot_runtime.EnumOriginCaller Origin { get; set; }
        /// <summary>
        /// >> proposal
        /// </summary>
        public Substrate.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded Proposal { get; set; }
        /// <summary>
        /// >> enactment
        /// </summary>
        public Substrate.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime Enactment { get; set; }
        /// <summary>
        /// >> submitted
        /// </summary>
        ...
        /// >> submission_deposit
        /// </summary>
        public Substrate.NetApi.Generated.Model.pallet_referenda.types.Deposit SubmissionDeposit { get; set; }
        /// <summary>
        /// >> decision_deposit
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.pallet_referenda.types.Deposit> DecisionDeposit { get; set; }
        /// <summary>
        /// >> deciding
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.pallet_referenda.types.DecidingStatus> Deciding { get; set; }
        /// <summary>
        /// >> tally
        /// </summary>
        public Substrate.NetApi.Generated.Model.pallet_conviction_voting.types.Tally Tally { get; set; }
        /// <summary>
        /// >> in_queue
        /// </summary>
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Enactment = new Substrate.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime();
            Enactment.Decode(byteArray, ref p);
            Submitted = new Substrate.NetApi.Model.Types.Primitive.U32();
            Submitted.Decode(byteArray, ref p);
            SubmissionDeposit = new Substrate.NetApi.Generated.Model.pallet_referenda.types.Deposit();
            SubmissionDeposit.Decode(byteArray, ref p);
            DecisionDeposit = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.pallet_referenda.types.Deposit>();
            DecisionDeposit.Decode(byteArray, ref p);
            Deciding = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.pallet_referenda.types.DecidingStatus>();
            Deciding.Decode(byteArray, ref p);
            Tally = new Substrate.NetApi.Generated.Model.pallet_conviction_voting.types.Tally();
