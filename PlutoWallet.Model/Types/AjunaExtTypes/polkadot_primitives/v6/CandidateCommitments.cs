...
namespace Substrate.NetApi.Generated.Model.polkadot_primitives.v6
{
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        /// >> upward_messages
        /// </summary>
        public Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 UpwardMessages { get; set; }
        /// <summary>
        /// >> horizontal_messages
        /// </summary>
        public Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 HorizontalMessages { get; set; }
        /// <summary>
        /// >> new_validation_code
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.ValidationCode> NewValidationCode { get; set; }
        /// <summary>
        /// >> head_data
        /// </summary>
        public Substrate.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.HeadData HeadData { get; set; }
        /// <summary>
        ...
        {
            var start = p;
            UpwardMessages = new Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            UpwardMessages.Decode(byteArray, ref p);
            HorizontalMessages = new Substrate.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            HorizontalMessages.Decode(byteArray, ref p);
            NewValidationCode = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.ValidationCode>();
            NewValidationCode.Decode(byteArray, ref p);
            HeadData = new Substrate.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.HeadData();
