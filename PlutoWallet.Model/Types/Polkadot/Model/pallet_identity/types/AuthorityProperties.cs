...
namespace Polkadot.NetApi.Generated.Model.pallet_identity.types
{
    ...
    public sealed class AuthorityProperties : BaseType
    {
        ...
        /// >> suffix
        /// </summary>
        public Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 Suffix { get; set; }
        /// <summary>
        /// >> allocation
        /// </summary>
        ...
        {
            var start = p;
            Suffix = new Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31();
