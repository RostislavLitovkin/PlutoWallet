...
namespace Mythos.NetApi.Generated.Storage
{
    ...
    public sealed class CollatorSelectionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Invulnerables"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Mythos.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "CandidateList"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Mythos.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18)));
        ...
        ///  The invulnerable, permissioned collators. This list must be sorted.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17> Invulnerables(string blockhash, CancellationToken token)
        {
        ...
        ///  recently updated is considered greater.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18> CandidateList(string blockhash, CancellationToken token)
        {
    ...
    public sealed class CollatorSelectionCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TakeCandidateSlot(Substrate.NetApi.Model.Types.Primitive.U128 deposit, Mythos.NetApi.Generated.Model.account.AccountId20 target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
