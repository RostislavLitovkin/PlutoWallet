...
namespace Bifrost.NetApi.Generated.Model.frame_system
{
    ...
    public sealed class EventRecord : BaseType
    {
        ...
        /// >> phase
        /// </summary>
        public Bifrost.NetApi.Generated.Model.frame_system.EnumPhase Phase { get; set; }
        /// <summary>
        /// >> event
        /// </summary>
        public Bifrost.NetApi.Generated.Model.bifrost_polkadot_runtime.EnumRuntimeEvent Event { get; set; }
        /// <summary>
        /// >> topics
        /// </summary>
        ...
        {
            var start = p;
            Phase = new Bifrost.NetApi.Generated.Model.frame_system.EnumPhase();
            Phase.Decode(byteArray, ref p);
            Event = new Bifrost.NetApi.Generated.Model.bifrost_polkadot_runtime.EnumRuntimeEvent();
