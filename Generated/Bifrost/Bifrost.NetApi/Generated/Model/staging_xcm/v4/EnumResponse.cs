...
namespace Bifrost.NetApi.Generated.Model.staging_xcm.v4
{
    ...
    /// <summary>
    /// >> 210 - Variant[staging_xcm.v4.Response]
    /// </summary>
    public sealed class EnumResponse : BaseEnumRust<Response>
    {
        ...
        public EnumResponse()
        {
				...
				AddTypeDecoder<Bifrost.NetApi.Generated.Model.staging_xcm.v4.asset.Assets>(Response.Assets);
				...
				AddTypeDecoder<Bifrost.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5>(Response.PalletsInfo);
