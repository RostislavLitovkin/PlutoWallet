...
namespace Bifrost.NetApi.Generated.Model.pallet_treasury
{
    ...
    /// <summary>
    /// >> 759 - Composite[pallet_treasury.Proposal]
    /// </summary>
    ...
    public sealed class Proposal : BaseType
    {
        ...
        /// >> proposer
        /// </summary>
        public Bifrost.NetApi.Generated.Model.sp_core.crypto.AccountId32 Proposer { get; set; }
        /// <summary>
        /// >> value
        /// </summary>
        ...
        {
            var start = p;
            Proposer = new Bifrost.NetApi.Generated.Model.sp_core.crypto.AccountId32();
