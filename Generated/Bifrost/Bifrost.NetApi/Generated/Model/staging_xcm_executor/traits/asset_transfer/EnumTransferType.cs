...
namespace Bifrost.NetApi.Generated.Model.staging_xcm_executor.traits.asset_transfer
{
    ...
    /// <summary>
    /// >> 232 - Variant[staging_xcm_executor.traits.asset_transfer.TransferType]
    /// </summary>
    public sealed class EnumTransferType : BaseEnumRust<TransferType>
    {
        ...
        public EnumTransferType()
        {
				...
				AddTypeDecoder<Bifrost.NetApi.Generated.Model.xcm.EnumVersionedLocation>(TransferType.RemoteReserve);
        }
    }
}
