    ...
    public sealed class UnknownTokensStorage
    {
        ...
        public UnknownTokensStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("UnknownTokens", "ConcreteFungibleBalances"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location, Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location>), typeof(Substrate.NetApi.Model.Types.Primitive.U128)));
        ...
        /// </summary>
        public static string ConcreteFungibleBalancesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location, Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location> key)
        {
        ...
        ///  double_map: who, asset_id => u128
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> ConcreteFungibleBalances(Substrate.NetApi.Model.Types.Base.BaseTuple<Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location, Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location> key, string blockhash, CancellationToken token)
        {
        ...
        ///  double_map: who, asset_id => u128
        /// </summary>
        public static string AbstractFungibleBalancesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key)
        {
        ...
        ///  double_map: who, asset_id => u128
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> AbstractFungibleBalances(Substrate.NetApi.Model.Types.Base.BaseTuple<Bifrost.NetApi.Generated.Model.staging_xcm.v4.location.Location, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key, string blockhash, CancellationToken token)
        {
