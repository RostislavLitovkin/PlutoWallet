...
namespace Bifrost.NetApi.Generated.Storage
{
    ...
    public sealed class EVMAccountsStorage
    {
        ...
        public EVMAccountsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EVMAccounts", "AccountExtension"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Bifrost.NetApi.Generated.Model.primitive_types.H160), typeof(Bifrost.NetApi.Generated.Types.Base.Arr12U8)));
        ...
        /// </summary>
        public static string AccountExtensionParams(Bifrost.NetApi.Generated.Model.primitive_types.H160 key)
        {
        ...
        ///  Maps an EVM address to the last 12 bytes of a substrate account.
        /// </summary>
        public async Task<Bifrost.NetApi.Generated.Types.Base.Arr12U8> AccountExtension(Bifrost.NetApi.Generated.Model.primitive_types.H160 key, string blockhash, CancellationToken token)
        {
            string parameters = EVMAccountsStorage.AccountExtensionParams(key);
            var result = await _client.GetStorageAsync<Bifrost.NetApi.Generated.Types.Base.Arr12U8>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ContractDeployerParams(Bifrost.NetApi.Generated.Model.primitive_types.H160 key)
        {
        ...
        ///  Whitelisted addresses that are allowed to deploy smart contracts.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> ContractDeployer(Bifrost.NetApi.Generated.Model.primitive_types.H160 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class EVMAccountsCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddContractDeployer(Bifrost.NetApi.Generated.Model.primitive_types.H160 address)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveContractDeployer(Bifrost.NetApi.Generated.Model.primitive_types.H160 address)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(address.Encode());
