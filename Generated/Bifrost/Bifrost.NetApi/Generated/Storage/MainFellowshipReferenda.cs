...
namespace Bifrost.NetApi.Generated.Storage
{
    ...
    public sealed class FellowshipReferendaStorage
    {
        ...
        public FellowshipReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(Bifrost.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT61)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "MetadataOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Bifrost.NetApi.Generated.Model.primitive_types.H256)));
        }
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public async Task<Bifrost.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoFor(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = FellowshipReferendaStorage.ReferendumInfoForParams(key);
            var result = await _client.GetStorageAsync<Bifrost.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<Bifrost.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT61> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
        ...
        ///  large preimages.
        /// </summary>
        public async Task<Bifrost.NetApi.Generated.Model.primitive_types.H256> MetadataOf(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class FellowshipReferendaCalls
    {
        ...
        /// </summary>
        public static Method Submit(Bifrost.NetApi.Generated.Model.bifrost_polkadot_runtime.EnumOriginCaller proposal_origin, Bifrost.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, Bifrost.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetMetadata(Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.NetApi.Model.Types.Base.BaseOpt<Bifrost.NetApi.Generated.Model.primitive_types.H256> maybe_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
    ...
    public sealed class FellowshipReferendaConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Bifrost.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            var result = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Bifrost.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>>();
            result.Create("0x2800002863616E646964617465730A00000000407A10F35A0000000000000000000005000000403" +
                    "8000019000000050000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32301001C6" +
                    "D656D626572730A00000000A0724E180900000000000000000000050000004038000019000000050" +
                    "000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32302002C70726F66696369656" +
                    "E74730A00000000A0724E18090000000000000000000005000000403800001900000005000000000" +
                    "0CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32303001C66656C6C6F77730A00000000A" +
                    "0724E180900000000000000000000050000004038000019000000050000000000CA9A3B0065CD1D0" +
                    "0CA9A3B0000CA9A3B0065CD1D0046C32304003873656E696F722066656C6C6F77730A00000000A07" +
                    "24E180900000000000000000000050000004038000019000000050000000000CA9A3B0065CD1D00C" +
                    "A9A3B0000CA9A3B0065CD1D0046C32305001C657870657274730A0000000010A5D4E800000000000" +
                    "00000000000050000004038000019000000050000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0" +
                    "065CD1D0046C32306003873656E696F7220657870657274730A0000000010A5D4E80000000000000" +
                    "000000000050000004038000019000000050000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B006" +
                    "5CD1D0046C32307001C6D6173746572730A0000000010A5D4E800000000000000000000000500000" +
                    "04038000019000000050000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C323080" +
                    "03873656E696F72206D6173746572730A0000000010A5D4E80000000000000000000000050000004" +
                    "038000019000000050000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32309003" +
                    "46772616E64206D6173746572730A0000000010A5D4E800000000000000000000000500000040380" +
                    "00019000000050000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C323");
            return result;
        }
    }
