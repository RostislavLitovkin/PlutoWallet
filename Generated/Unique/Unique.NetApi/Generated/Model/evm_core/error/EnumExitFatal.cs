...
namespace Unique.NetApi.Generated.Model.evm_core.error
{
    ...
    public sealed class EnumExitFatal : BaseEnumRust<ExitFatal>
    {
        ...
        public EnumExitFatal()
        {
				...
				AddTypeDecoder<Unique.NetApi.Generated.Model.evm_core.error.EnumExitError>(ExitFatal.CallErrorAsFatal);
				AddTypeDecoder<Unique.NetApi.Generated.Types.Base.CowT1>(ExitFatal.Other);
        }
    }
}
