...
namespace Unique.NetApi.Generated.Storage
{
    ...
    public sealed class ForeignAssetsStorage
    {
        ...
        public ForeignAssetsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ForeignAssets", "ForeignAssetToCollection"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetId), typeof(Unique.NetApi.Generated.Model.up_data_structs.CollectionId)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ForeignAssets", "CollectionToForeignAsset"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Unique.NetApi.Generated.Model.up_data_structs.CollectionId), typeof(Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetId)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ForeignAssets", "ForeignReserveAssetInstanceToTokenId"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Unique.NetApi.Generated.Model.up_data_structs.CollectionId, Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetInstance>), typeof(Unique.NetApi.Generated.Model.up_data_structs.TokenId)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ForeignAssets", "TokenIdToForeignReserveAssetInstance"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Unique.NetApi.Generated.Model.up_data_structs.CollectionId, Unique.NetApi.Generated.Model.up_data_structs.TokenId>), typeof(Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetInstance)));
        }
        ...
        /// </summary>
        public static string ForeignAssetToCollectionParams(Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetId key)
        {
        ...
        ///  The corresponding collections of foreign assets.
        /// </summary>
        public async Task<Unique.NetApi.Generated.Model.up_data_structs.CollectionId> ForeignAssetToCollection(Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetId key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string CollectionToForeignAssetParams(Unique.NetApi.Generated.Model.up_data_structs.CollectionId key)
        {
        ...
        ///  The corresponding foreign assets of collections.
        /// </summary>
        public async Task<Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetId> CollectionToForeignAsset(Unique.NetApi.Generated.Model.up_data_structs.CollectionId key, string blockhash, CancellationToken token)
        {
            string parameters = ForeignAssetsStorage.CollectionToForeignAssetParams(key);
            var result = await _client.GetStorageAsync<Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetId>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ForeignReserveAssetInstanceToTokenIdParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Unique.NetApi.Generated.Model.up_data_structs.CollectionId, Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetInstance> key)
        {
        ...
        ///  The correponding NFT token id of reserve NFTs
        /// </summary>
        public async Task<Unique.NetApi.Generated.Model.up_data_structs.TokenId> ForeignReserveAssetInstanceToTokenId(Substrate.NetApi.Model.Types.Base.BaseTuple<Unique.NetApi.Generated.Model.up_data_structs.CollectionId, Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetInstance> key, string blockhash, CancellationToken token)
        {
            string parameters = ForeignAssetsStorage.ForeignReserveAssetInstanceToTokenIdParams(key);
            var result = await _client.GetStorageAsync<Unique.NetApi.Generated.Model.up_data_structs.TokenId>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string TokenIdToForeignReserveAssetInstanceParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Unique.NetApi.Generated.Model.up_data_structs.CollectionId, Unique.NetApi.Generated.Model.up_data_structs.TokenId> key)
        {
        ...
        ///  The correponding reserve NFT of a token ID
        /// </summary>
        public async Task<Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetInstance> TokenIdToForeignReserveAssetInstance(Substrate.NetApi.Model.Types.Base.BaseTuple<Unique.NetApi.Generated.Model.up_data_structs.CollectionId, Unique.NetApi.Generated.Model.up_data_structs.TokenId> key, string blockhash, CancellationToken token)
        {
            string parameters = ForeignAssetsStorage.TokenIdToForeignReserveAssetInstanceParams(key);
            var result = await _client.GetStorageAsync<Unique.NetApi.Generated.Model.xcm.v3.multiasset.EnumAssetInstance>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class ForeignAssetsCalls
    {
        ...
        /// </summary>
        public static Method ForceRegisterForeignAsset(Unique.NetApi.Generated.Model.xcm.EnumVersionedAssetId versioned_asset_id, Unique.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 name, Unique.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 token_prefix, Unique.NetApi.Generated.Model.pallet_foreign_assets.EnumForeignCollectionMode mode)
        {
