...
namespace KusamaAssetHub.NetApi.Generated.Storage
{
    ...
    public sealed class SessionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "Validators"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "QueuedKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32, KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys>>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "NextKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "KeyOwner"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>>), typeof(KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The current set of validators.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32>> Validators(string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.ValidatorsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32, KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys>>> QueuedKeys(string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.QueuedKeysParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32, KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys>>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string NextKeysParams(KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public async Task<KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys> NextKeys(KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.NextKeysParams(key);
            var result = await _client.GetStorageAsync<KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string KeyOwnerParams(Substrate.NetApi.Model.Types.Base.BaseTuple<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key)
        {
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public async Task<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32> KeyOwner(Substrate.NetApi.Model.Types.Base.BaseTuple<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key, string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.KeyOwnerParams(key);
            var result = await _client.GetStorageAsync<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class SessionCalls
    {
        ...
        /// </summary>
        public static Method SetKeys(KusamaAssetHub.NetApi.Generated.Model.asset_hub_kusama_runtime.SessionKeys keys, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> proof)
        {
