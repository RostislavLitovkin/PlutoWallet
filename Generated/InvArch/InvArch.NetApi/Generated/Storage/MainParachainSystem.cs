...
namespace InvArch.NetApi.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<InvArch.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof> RelayStateProof(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelayStateProofParams();
            var result = await _client.GetStorageAsync<InvArch.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<InvArch.NetApi.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot> RelevantMessagingState(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelevantMessagingStateParams();
            var result = await _client.GetStorageAsync<InvArch.NetApi.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<InvArch.NetApi.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain> LastDmqMqcHead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastDmqMqcHeadParams();
            var result = await _client.GetStorageAsync<InvArch.NetApi.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This will be cleared in `on_initialize` of each new block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<InvArch.NetApi.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>> HrmpOutboundMessages(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HrmpOutboundMessagesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<InvArch.NetApi.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<InvArch.NetApi.Generated.Model.sp_weights.weight_v2.Weight> ReservedXcmpWeightOverride(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ReservedXcmpWeightOverrideParams();
            var result = await _client.GetStorageAsync<InvArch.NetApi.Generated.Model.sp_weights.weight_v2.Weight>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<InvArch.NetApi.Generated.Model.sp_weights.weight_v2.Weight> ReservedDmpWeightOverride(string blockhash, CancellationToken token)
        {
