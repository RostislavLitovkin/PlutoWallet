...
namespace InvArch.NetApi.Generated.Storage
{
    ...
    public sealed class IdentityStorage
    {
        ...
        /// </summary>
        public static string IdentityOfParams(InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// </summary>
        public static string SuperOfParams(InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  context. If the account is not some other account's sub-identity, then just `None`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32, InvArch.NetApi.Generated.Model.pallet_identity.types.EnumData>> SuperOf(InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = IdentityStorage.SuperOfParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32, InvArch.NetApi.Generated.Model.pallet_identity.types.EnumData>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: OK ��� `AccountId` is a secure hash.
        /// </summary>
        public static string SubsOfParams(InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
    ...
    public sealed class IdentityCalls
    {
        ...
        /// </summary>
        public static Method AddRegistrar(InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress account)
        {
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method SetSubs(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32, InvArch.NetApi.Generated.Model.pallet_identity.types.EnumData>> subs)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method SetAccountId(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method ProvideJudgement(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> reg_index, InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target, InvArch.NetApi.Generated.Model.pallet_identity.types.EnumJudgement judgement, InvArch.NetApi.Generated.Model.primitive_types.H256 identity)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(reg_index.Encode());
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method KillIdentity(InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method AddSub(InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress sub, InvArch.NetApi.Generated.Model.pallet_identity.types.EnumData data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method RenameSub(InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress sub, InvArch.NetApi.Generated.Model.pallet_identity.types.EnumData data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(sub.Encode());
            byteArray.AddRange(data.Encode());
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method RemoveSub(InvArch.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress sub)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(sub.Encode());
