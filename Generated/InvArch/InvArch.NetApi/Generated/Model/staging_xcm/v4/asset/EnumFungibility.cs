...
namespace InvArch.NetApi.Generated.Model.staging_xcm.v4.asset
{
    ...
    /// <summary>
    /// >> 90 - Variant[staging_xcm.v4.asset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<InvArch.NetApi.Generated.Model.staging_xcm.v4.asset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
