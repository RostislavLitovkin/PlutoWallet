...
namespace InvArch.NetApi.Generated.Model.staging_xcm.v4
{
    ...
    /// <summary>
    /// >> 115 - Composite[staging_xcm.v4.QueryResponseInfo]
    /// </summary>
    ...
    public sealed class QueryResponseInfo : BaseType
    {
        ...
        /// >> destination
        /// </summary>
        public InvArch.NetApi.Generated.Model.staging_xcm.v4.location.Location Destination { get; set; }
        /// <summary>
        /// >> query_id
        /// </summary>
        ...
        {
            var start = p;
            Destination = new InvArch.NetApi.Generated.Model.staging_xcm.v4.location.Location();
