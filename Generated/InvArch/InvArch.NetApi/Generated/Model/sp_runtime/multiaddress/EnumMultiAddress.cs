...
namespace InvArch.NetApi.Generated.Model.sp_runtime.multiaddress
{
    ...
    public sealed class EnumMultiAddress : BaseEnumRust<MultiAddress>
    {
        ...
        {
				AddTypeDecoder<InvArch.NetApi.Generated.Model.sp_core.crypto.AccountId32>(MultiAddress.Id);
				...
				AddTypeDecoder<InvArch.NetApi.Generated.Types.Base.Arr32U8>(MultiAddress.Address32);
				AddTypeDecoder<InvArch.NetApi.Generated.Types.Base.Arr20U8>(MultiAddress.Address20);
        }
    }
}
