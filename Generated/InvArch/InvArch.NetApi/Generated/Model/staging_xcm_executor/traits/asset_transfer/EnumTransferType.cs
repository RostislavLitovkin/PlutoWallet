...
namespace InvArch.NetApi.Generated.Model.staging_xcm_executor.traits.asset_transfer
{
    ...
    /// <summary>
    /// >> 255 - Variant[staging_xcm_executor.traits.asset_transfer.TransferType]
    /// </summary>
    public sealed class EnumTransferType : BaseEnumRust<TransferType>
    {
        ...
        public EnumTransferType()
        {
				...
				AddTypeDecoder<InvArch.NetApi.Generated.Model.xcm.EnumVersionedLocation>(TransferType.RemoteReserve);
        }
    }
}
