...
namespace Bajun.NetApi.Generated.Storage
{
    ...
    public sealed class SudoStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Sudo", "Key"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The `AccountId` of the sudo key.
        /// </summary>
        public async Task<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32> Key(string blockhash, CancellationToken token)
        {
    ...
    public sealed class SudoCalls
    {
        ...
        /// </summary>
        public static Method Sudo(Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall call)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SudoUncheckedWeight(Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall call, Bajun.NetApi.Generated.Model.sp_weights.weight_v2.Weight weight)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetKey(Bajun.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SudoAs(Bajun.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who, Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
