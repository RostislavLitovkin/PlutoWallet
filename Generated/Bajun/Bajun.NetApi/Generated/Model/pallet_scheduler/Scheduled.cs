...
namespace Bajun.NetApi.Generated.Model.pallet_scheduler
{
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Bajun.NetApi.Generated.Types.Base.Arr32U8> MaybeId { get; set; }
        /// <summary>
        /// >> priority
        /// </summary>
        ...
        /// >> call
        /// </summary>
        public Bajun.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded Call { get; set; }
        /// <summary>
        /// >> maybe_periodic
        /// </summary>
        ...
        /// >> origin
        /// </summary>
        public Bajun.NetApi.Generated.Model.bajun_runtime.EnumOriginCaller Origin { get; set; }
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Bajun.NetApi.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Bajun.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded();
            ...
            Origin = new Bajun.NetApi.Generated.Model.bajun_runtime.EnumOriginCaller();
