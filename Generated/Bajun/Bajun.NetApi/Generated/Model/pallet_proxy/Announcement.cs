...
namespace Bajun.NetApi.Generated.Model.pallet_proxy
{
    ...
    public sealed class Announcement : BaseType
    {
        ...
        /// >> real
        /// </summary>
        public Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32 Real { get; set; }
        /// <summary>
        /// >> call_hash
        /// </summary>
        public Bajun.NetApi.Generated.Model.primitive_types.H256 CallHash { get; set; }
        /// <summary>
        /// >> height
        /// </summary>
        ...
        {
            var start = p;
            Real = new Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Bajun.NetApi.Generated.Model.primitive_types.H256();
