...
namespace Bajun.NetApi.Generated.Model.staging_xcm.v4
{
    ...
    public sealed class QueryResponseInfo : BaseType
    {
        ...
        /// >> destination
        /// </summary>
        public Bajun.NetApi.Generated.Model.staging_xcm.v4.location.Location Destination { get; set; }
        /// <summary>
        /// >> query_id
        /// </summary>
        ...
        {
            var start = p;
            Destination = new Bajun.NetApi.Generated.Model.staging_xcm.v4.location.Location();
