...
namespace Substrate.RestService.Generated.Storage
{
    ...
    public interface ITechnicalCommitteeStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44 GetProposals();
        
        /// <summary>
        /// >> ProposalOf
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall GetProposalOf(string key);
        
        /// <summary>
        /// >> Voting
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        Bajun.NetApi.Generated.Model.pallet_collective.Votes GetVoting(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32> GetMembers();
    ...
    public sealed class TechnicalCommitteeStorage : ITechnicalCommitteeStorage
    {
        ...
        /// </summary>
        private TypedStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44> _proposalsTypedStorage;
        
        /// <summary>
        /// _proposalOfTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall> _proposalOfTypedStorage;
        
        /// <summary>
        /// _votingTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.pallet_collective.Votes> _votingTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32>> _membersTypedStorage;
        ...
        {
            this.ProposalsTypedStorage = new TypedStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44>("TechnicalCommittee.Proposals", storageDataProvider, storageChangeDelegates);
            this.ProposalOfTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall>("TechnicalCommittee.ProposalOf", storageDataProvider, storageChangeDelegates);
            this.VotingTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.pallet_collective.Votes>("TechnicalCommittee.Voting", storageDataProvider, storageChangeDelegates);
            ...
            this.MembersTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32>>("TechnicalCommittee.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32>("TechnicalCommittee.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _proposalsTypedStorage property
        /// </summary>
        public TypedStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall> ProposalOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.pallet_collective.Votes> VotingTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32>> MembersTypedStorage
        {
            get
            {
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44 GetProposals()
        {
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall GetProposalOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalOfTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.bajun_runtime.EnumRuntimeCall result))
            {
                return result;
            }
            else
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public Bajun.NetApi.Generated.Model.pallet_collective.Votes GetVoting(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.pallet_collective.Votes result))
            {
                return result;
            }
            else
        ...
        ///  The current members of the collective. This is stored sorted (just by value).
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32> GetMembers()
        {
