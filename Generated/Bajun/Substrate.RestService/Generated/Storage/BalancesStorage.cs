...
namespace Substrate.RestService.Generated.Storage
{
    ...
    public interface IBalancesStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.NetApi.Generated.Model.pallet_balances.types.AccountData GetAccount(string key);
        ...
        /// </summary>
        Bajun.NetApi.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2 GetLocks(string key);
        ...
        /// </summary>
        Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 GetReserves(string key);
        
        /// <summary>
        /// >> Holds
        ///  Holds on account balances.
        /// </summary>
        Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33 GetHolds(string key);
        
        /// <summary>
        /// >> Freezes
        ///  Freeze locks on account balances.
        /// </summary>
        Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 GetFreezes(string key);
    }
    ...
    public sealed class BalancesStorage : IBalancesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.pallet_balances.types.AccountData> _accountTypedStorage;
        
        /// <summary>
        /// _locksTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2> _locksTypedStorage;
        
        /// <summary>
        /// _reservesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32> _reservesTypedStorage;
        
        /// <summary>
        /// _holdsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33> _holdsTypedStorage;
        
        /// <summary>
        /// _freezesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> _freezesTypedStorage;
        ...
        public BalancesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AccountTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.pallet_balances.types.AccountData>("Balances.Account", storageDataProvider, storageChangeDelegates);
            this.LocksTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2>("Balances.Locks", storageDataProvider, storageChangeDelegates);
            this.ReservesTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32>("Balances.Reserves", storageDataProvider, storageChangeDelegates);
            this.HoldsTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33>("Balances.Holds", storageDataProvider, storageChangeDelegates);
            this.FreezesTypedStorage = new TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34>("Balances.Freezes", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.pallet_balances.types.AccountData> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2> LocksTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32> ReservesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33> HoldsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> FreezesTypedStorage
        {
            get
            {
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public Bajun.NetApi.Generated.Model.pallet_balances.types.AccountData GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.pallet_balances.types.AccountData result))
            {
                return result;
            }
            else
        ...
        ///  Use of locks is deprecated in favour of freezes. See `https://github.com/paritytech/substrate/pull/12951/`
        /// </summary>
        public Bajun.NetApi.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2 GetLocks(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LocksTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2 result))
            {
                return result;
            }
            else
        ...
        ///  Use of reserves is deprecated in favour of holds. See `https://github.com/paritytech/substrate/pull/12951/`
        /// </summary>
        public Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 GetReserves(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReservesTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 result))
            {
                return result;
            }
            else
        ...
        ///  Holds on account balances.
        /// </summary>
        public Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33 GetHolds(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (HoldsTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33 result))
            {
                return result;
            }
            else
        ...
        ///  Freeze locks on account balances.
        /// </summary>
        public Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 GetFreezes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (FreezesTypedStorage.Dictionary.TryGetValue(key, out Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 result))
            {
                return result;
            }
            else
