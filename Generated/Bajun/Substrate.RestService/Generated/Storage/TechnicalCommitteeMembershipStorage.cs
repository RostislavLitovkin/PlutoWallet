...
namespace Substrate.RestService.Generated.Storage
{
    ...
    public interface ITechnicalCommitteeMembershipStorage : IStorage
    {
        ...
        /// </summary>
        Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT46 GetMembers();
    ...
    public sealed class TechnicalCommitteeMembershipStorage : ITechnicalCommitteeMembershipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT46> _membersTypedStorage;
        ...
        {
            this.MembersTypedStorage = new TypedStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT46>("TechnicalCommitteeMembership.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Bajun.NetApi.Generated.Model.sp_core.crypto.AccountId32>("TechnicalCommitteeMembership.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _membersTypedStorage property
        /// </summary>
        public TypedStorage<Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT46> MembersTypedStorage
        {
            get
            {
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public Bajun.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT46 GetMembers()
        {
