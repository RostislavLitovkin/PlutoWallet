   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         else
         {
            ...
            _storageDataProvider = new SubstrateDataProvider(Environment.GetEnvironmentVariable("SUBSTRATE_WEBSOCKET_ENDPOINT") ?? "wss://bajun.public.curie.radiumblock.co/ws");
         }
