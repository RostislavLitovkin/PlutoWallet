...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        public ParachainSystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ValidationData"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.polkadot_primitives.v7.PersistedValidationData)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeRestrictionSignal"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.EnumUpgradeRestriction>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeGoAhead"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.EnumUpgradeGoAhead>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "HostConfiguration"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.polkadot_primitives.v7.AbridgedHostConfiguration)));
        ...
        ///  in the trie.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.PersistedValidationData> ValidationData(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ValidationDataParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.PersistedValidationData>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.EnumUpgradeRestriction>> UpgradeRestrictionSignal(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeRestrictionSignalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.EnumUpgradeRestriction>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.EnumUpgradeGoAhead>> UpgradeGoAhead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeGoAheadParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.EnumUpgradeGoAhead>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.AbridgedHostConfiguration> HostConfiguration(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HostConfigurationParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.polkadot_primitives.v7.AbridgedHostConfiguration>(parameters, blockhash, token);
            return result;
        }
