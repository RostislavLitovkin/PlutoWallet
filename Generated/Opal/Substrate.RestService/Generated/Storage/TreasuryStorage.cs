...
namespace Substrate.RestService.Generated.Storage
{
    ...
    public interface ITreasuryStorage : IStorage
    {
        ...
        /// </summary>
        Opal.NetApi.Generated.Model.pallet_treasury.Proposal GetProposals(string key);
        ...
        /// </summary>
        Opal.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 GetApprovals();
        ...
        /// </summary>
        Opal.NetApi.Generated.Model.pallet_treasury.SpendStatus GetSpends(string key);
    }
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApi.Generated.Model.pallet_treasury.Proposal> _proposalsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Opal.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23> _approvalsTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApi.Generated.Model.pallet_treasury.SpendStatus> _spendsTypedStorage;
        ...
        public TreasuryStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ProposalsTypedStorage = new TypedMapStorage<Opal.NetApi.Generated.Model.pallet_treasury.Proposal>("Treasury.Proposals", storageDataProvider, storageChangeDelegates);
            ...
            this.ApprovalsTypedStorage = new TypedStorage<Opal.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23>("Treasury.Approvals", storageDataProvider, storageChangeDelegates);
            ...
            this.SpendsTypedStorage = new TypedMapStorage<Opal.NetApi.Generated.Model.pallet_treasury.SpendStatus>("Treasury.Spends", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApi.Generated.Model.pallet_treasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Opal.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23> ApprovalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApi.Generated.Model.pallet_treasury.SpendStatus> SpendsTypedStorage
        {
            get
            {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public Opal.NetApi.Generated.Model.pallet_treasury.Proposal GetProposals(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApi.Generated.Model.pallet_treasury.Proposal result))
            {
                return result;
            }
            else
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public Opal.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 GetApprovals()
        {
        ...
        ///  Spends that have been approved and being processed.
        /// </summary>
        public Opal.NetApi.Generated.Model.pallet_treasury.SpendStatus GetSpends(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SpendsTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApi.Generated.Model.pallet_treasury.SpendStatus result))
            {
                return result;
            }
            else
