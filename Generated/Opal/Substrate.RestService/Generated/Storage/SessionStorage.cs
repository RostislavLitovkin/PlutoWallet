...
namespace Substrate.RestService.Generated.Storage
{
    ...
    public interface ISessionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32> GetValidators();
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32, Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys>> GetQueuedKeys();
        ...
        /// </summary>
        Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys GetNextKeys(string key);
        
        /// <summary>
        /// >> KeyOwner
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 GetKeyOwner(string key);
    }
    ...
    public sealed class SessionStorage : ISessionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32>> _validatorsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32, Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys>>> _queuedKeysTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys> _nextKeysTypedStorage;
        
        /// <summary>
        /// _keyOwnerTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32> _keyOwnerTypedStorage;
        ...
        {
            this.ValidatorsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32>>("Session.Validators", storageDataProvider, storageChangeDelegates);
            ...
            this.QueuedKeysTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32, Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys>>>("Session.QueuedKeys", storageDataProvider, storageChangeDelegates);
            ...
            this.NextKeysTypedStorage = new TypedMapStorage<Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys>("Session.NextKeys", storageDataProvider, storageChangeDelegates);
            this.KeyOwnerTypedStorage = new TypedMapStorage<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32>("Session.KeyOwner", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _validatorsTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32>> ValidatorsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32, Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys>>> QueuedKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys> NextKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32> KeyOwnerTypedStorage
        {
            get
            {
        ...
        ///  The current set of validators.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32> GetValidators()
        {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32, Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys>> GetQueuedKeys()
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys GetNextKeys(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (NextKeysTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApi.Generated.Model.opal_runtime.runtime_common.SessionKeys result))
            {
                return result;
            }
            else
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 GetKeyOwner(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (KeyOwnerTypedStorage.Dictionary.TryGetValue(key, out Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
