...
namespace Substrate.RestService.Generated.Storage
{
    ...
    public interface IAuthorshipStorage : IStorage
    {
        ...
        /// </summary>
        Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 GetAuthor();
    }
    ...
    public sealed class AuthorshipStorage : IAuthorshipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32> _authorTypedStorage;
        ...
        {
            this.AuthorTypedStorage = new TypedStorage<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32>("Authorship.Author", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _authorTypedStorage property
        /// </summary>
        public TypedStorage<Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32> AuthorTypedStorage
        {
            get
            {
        ...
        ///  Author of current block.
        /// </summary>
        public Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 GetAuthor()
        {
